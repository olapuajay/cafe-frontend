  ...
  return (
    ...
    >
      <div className="text-start w-full md:w-2/3 lg:w-1/2">
        <h1 className="text-4xl md:text-5xl text-white font-bold font-serif mb-4">DevBean</h1>
        <p className="md:text-lg text-md text-gray-300 mb-6">
          Every Bean, Every Bite, Made to Delight.
        </p>
        <p className="md:text-xl text-md text-gray-300">
          Discover the taste of home with our handcrafted pastries, artisan breads, and freshly brewed coffee.
Order online or visit us to experience the magic.
        </p>
